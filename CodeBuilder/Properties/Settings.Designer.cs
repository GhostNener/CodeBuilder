...
namespace CodeBuilder.Properties {
    ...
    internal sealed partial class Settings : global::System.Configuration.ApplicationSettingsBase {
        ...
        [global::System.Configuration.DefaultSettingValueAttribute("using System;\r\nusing System.Collections.Generic;\r\nusing System.Data;\r\nusing Syste" +
            ...
            "T ToModel<T>(DataRow row) where T : class,new()\r\n        {\r\n            var prLi" +
            "st = GetPropertyInfo<T>(row.Table);\r\n            var item = new T();\r\n          " +
            "  prList.ForEach(p =>\r\n            {\r\n                if (row[p.Name] != DBNull." +
            "Value)\r\n                {\r\n                    p.SetValue(item, row[p.Name], nul" +
            "l);\r\n                }\r\n            });\r\n            return item;\r\n        }\r\n  " +
            "      public static List<PropertyInfo> GetPropertyInfo<T>(DataTable dt) where T " +
            ": class,new()\r\n        {\r\n            Type type = typeof(T);\r\n            var pr" +
            "List = new List<PropertyInfo>();\r\n            Array.ForEach(type.GetProperties()" +
            ", p =>\r\n            {\r\n                if (dt.Columns.Contains(p.Name))\r\n       " +
            "         {\r\n                    prList.Add(p);\r\n                }\r\n            }" +
            ");\r\n            return prList;\r\n        }\r\n        public static List<T> ToList<" +
            "T>(DataTable dt) where T : class,new()\r\n        {\r\n            var prList=GetPro" +
            "pertyInfo<T>(dt);\r\n            List<T> ls = new List<T>();\r\n            foreach " +
            "(DataRow row in dt.Rows)\r\n            {\r\n                var item = new T();\r\n  " +
            "              prList.ForEach(p =>\r\n                {\r\n                    if (ro" +
            "w[p.Name] != DBNull.Value)\r\n                    {\r\n                        p.Set" +
            "Value(item, row[p.Name], null);\r\n                    }\r\n                });\r\n   " +
            "             ls.Add(item);\r\n            }\r\n            return ls;\r\n        }\r\n  " +
            "      public static string GetWhereStr<T>(T entity, string tableName, out List<S" +
            "qlParameter> list, params string[] fields) where T : new()\r\n        {\r\n         " +
            "   StringBuilder sbu = new StringBuilder();\r\n            list = new List<SqlPara" +
            "meter>();\r\n\r\n            sbu.Append(\"\");\r\n            sbu.Append(\"select * from " +
            "[\" + tableName + \"] where (1=1)\");\r\n            if (fields != null)\r\n           " +
            " {\r\n                //遍历每一个要生成SQL的字段，取出内容\r\n                foreach (string field" +
            " in fields)\r\n                {\r\n                    object value = entity.GetTyp" +
            "e().GetProperty(field).GetValue(entity, null);\r\n                    if (value is" +
            " int || value is double || value is decimal || value is double || value is long " +
            "|| value is float)\r\n                    {\r\n\r\n                        sbu.AppendF" +
            "ormat(\" and ([{0}]=@{0})\", field);\r\n                        list.Add(new SqlPara" +
            "meter(\"@\" + field + \"\", value));\r\n\r\n                    }\r\n                    e" +
            "lse if (value is DateTime)\r\n                    {\r\n                        sbu.A" +
            "ppendFormat(\" and ([{0}]=@{0})\", field);\r\n                        list.Add(new S" +
            "qlParameter(\"@\" + field + \"\", Convert.ToDateTime(value)));\r\n\r\n                  " +
            "  }\r\n                    else if (value is Guid)\r\n                    {\r\n       " +
            "                 sbu.AppendFormat(\" and ([{0}]=@{0})\", field);\r\n                " +
            "        list.Add(new SqlParameter(\"@\" + field + \"\", new Guid(value.ToString())))" +
            ";\r\n\r\n                    }\r\n                    else if (value is Boolean)\r\n    " +
            "                {\r\n                        sbu.AppendFormat(\" and ([{0}]=@{0})\"," +
            " field);\r\n                        list.Add(new SqlParameter(\"@\" + field + \"\", Co" +
            "nvert.ToBoolean(value)));\r\n\r\n                    }\r\n                    else if " +
            "(value is String || value is Char)\r\n                    {\r\n                     " +
            "   sbu.AppendFormat(\" and ([{0}]=@{0})\", field);\r\n                        list.A" +
            "dd(new SqlParameter(\"@\" + field + \"\", Convert.ToString(value)));\r\n\r\n            " +
            "        }\r\n                    else\r\n                    {\r\n                    " +
            "    sbu.AppendFormat(\" and ([{0}]=@{0})\", field);\r\n                        list." +
            "Add(new SqlParameter(\"@\" + field + \"\", Helper.SqlHelper.ToDBValue(value)));\r\n   " +
            "                 }\r\n                }\r\n            }\r\n            return (sbu.To" +
            "String());\r\n        }\r\n    }\r\n}")]
